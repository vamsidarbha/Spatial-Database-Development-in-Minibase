      ...
      for (int i = 0; i < nOutFlds; i++)
	{
	  switch (perm_mat[i].relation.key)
		...
		case AttrType.attrShape:
			Jtuple.setShapeFld(i+1, t1.getShape_Geometry(perm_mat[i].offset));
			  break;
		default:
      ...
      for (int i = 0; i < nOutFlds; i++)
	{
	  switch (perm_mat[i].relation.key)
		...
		case AttrType.attrString:
		  ...
		  break;
		case AttrType.attrShape:
				//int a=t1.getShape_Geometry(perm_mat[i].offset);
			  Jtuple.setShapeFld(i+1, t1.getShape_Geometry(perm_mat[i].offset));
			  break;
		default:
...
//public static void Area(Tuple tempTuple1, AttrType[] _in1, Tuple jtuple,
...
//	    {
//	    case RelSpec.outer:      // Field of outer (t1)
//	      switch (_in1[perm_mat[i].offset-1].attrType)
//		{
//		case AttrType.attrString:
//		  
//		  Shape_Geometry g=tempTuple1.getClass();
//		  Jtuple.setStrFld(i+1, t1.getStrFld(perm_mat[i].offset));
//		  break;
//		default:
//		  
